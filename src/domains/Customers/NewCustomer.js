import { Col, Select, Image, Row, InputNumber, Button, Table, Input, Radio, Checkbox} from "antd";
  ...
  <Row gutter={[32, 16]}>
    <div className="Col1">
      <Col>
        ...
        <Row gutter={16}>
          ...
          <Col>
            <Select
              defaultValue="결제정보" size="small" onChange={handleChange}
              options={[
                { value: '바우처', label: '바우처' },
                { value: '실비', label: '실비' },
    ...
    <div className="Col2">
      ...
      <Row gutter={16}>
        ...
        <Col>
            <Input size="small" style={{width: 80}}></Input>
        </Col>
      </Row><br></br>
      <Row gutter={16}>
        <Col>
      ...
      <Row gutter={16}>
        ...
        <Col>
          <InputNumber size="small"/> (년생)
        </Col>
      </Row><br></br>
      <Row gutter={16}>
        <Col>
          <InputNumber size="small" style={{width: 60}}/> cm /
        </Col>
        <Col>
          <InputNumber size="small" style={{width: 60}}/> kg
        </Col>
      </Row><br></br>
      <Row gutter={16}>
        <Col>
      ...
      <Row gutter={10}>
          ...
          <Col>
          <Input placeholder="전화번호" size="small" style={{width : 150}} allowClear onChange={onTextChange} />
    ...
    <div className="Col3">
      <Col>
        ...
        <Row gutter={16}>
          ...
          <Col>
            <Select
              defaultValue="이용중" size="small" onChange={handleChange}
              options={[
                { value: '이용증', label: '이용중' },
        ...
        <Row gutter={16}>
          ...
          <Col>
            <Select
              defaultValue="담당자" size="small" onChange={handleChange}
              options={[
                { value: '김광운', label: '김광운' },
                { value: '문하늘', label: '문하늘' },
                { value: '김지수', label: '김지수'},
        ...
        <Row gutter={16}>
          ...
          <Col>
            <Select
              defaultValue="운동목적" size="small" onChange={handleChange}
              options={[
        ...
        <Row gutter={16}>
          ...
          <Col>
            <Select
              defaultValue="소개정보" size="small" onChange={handleChange}
              options={[
                { value: '숨고', label: '숨고' },
        ...
        <Row gutter={16}>
          ...
          <Col>
            <Select
              defaultValue="회원권" size="small" onChange={handleChange}
              options={[
          ...
          <Row gutter={16}>
            ...
            <Col>
            <Input placeholder="회원 주소" size="small" style={{width : 150}} allowClear onChange={onTextChange} />
            </Col>
        </Row>
      </Col>
      </div>
